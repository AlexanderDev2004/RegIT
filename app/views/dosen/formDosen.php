    ...
    <div class="flex w-full mx-auto">
        <div class="w-64 h-screen bg-[#132145] text-white flex flex-col items-center py-6 absolute top-0">
            ...
            <nav class="w-64 flex flex-col">
                <a href="dosen.php" target="" class="flex items-center gap-4 px-6 py-3 mb-2 bg-[#132145] rounded-lg text-white rounded-lg text-sm font-bold hover:bg-yellow-600">
            ...
            <label for="nim" class="block text-sm font-bold text-black">NIM</label>
                <form action="#" class="order-first mb-10 md:mb-0 md:order-last md:pr-8 mt-6">
                    ...
                    <div class="flex justify-between mt-6 pt-4">
                        ...
                        <button type="button" class="bg-gray-300 text-gray-700 px-4 py-2 rounded-md shadow hover:bg-gray-400 focus:outline-none focus:ring-2 focus:ring-gray-400">Kembali</button>
                    </div>
                </form>
        </div>
    </div>
