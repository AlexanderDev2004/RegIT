    ...
    <div class="flex w-full mx-auto">
        <div class="w-64 h-screen bg-[#132145] text-white flex flex-col items-center py-6 absolute top-0">
            ...
            <nav class="w-64 flex flex-col">
                ...
                <a href="dataDPA.php" target="" class="flex items-center gap-4 px-6 py-3 mb-2 bg-[#132145] rounded-lg text-white rounded-lg text-sm font-bold hover:bg-yellow-600 bg-[#F99D1C]">
                <img src="../../Public/personalcard.svg" alt="">
        ...
        <table class="w-full border-collapse border border-[#132145] text-sm text-left">
                <thead class="bg-white text-gray-800">
                    <tr>
                        ...
                        <th class="border border-[#132145] px-4 py-2">Nama DPA</th>
                        <th class="border border-[#132145] px-4 py-2">Prodi</th>
                        <th class="border border-[#132145] px-4 py-2">Kelas</th>
                ...
                <tbody>
                    <tr class="bg-white">
                        ...
                        <td class="border border-[#132145] px-4 py-2">Dosen DPA123 </td>
                        <td class="border border-[#132145] px-4 py-2 text-center">Teknik Informatika</td>
                        <td class="border border-[#132145] px-4 py-2 text-center">2H</td>
                    ...
                    <tr class="bg-white">
                        ...
                        <td class="border border-[#132145] px-4 py-2">Dosen DPA234</td>
                        <td class="border border-[#132145] px-4 py-2 text-center">Sistem Informasi Bisnis</td>
                        <td class="border border-[#132145] px-4 py-2 text-center">1A</td>
                    ...
                    <tr class="bg-white">
                        ...
                        <td class="border border-[#132145] px-4 py-2">Dosen DPA345 </td>
                        <td class="border border-[#132145] px-4 py-2 text-center">Sistem Informasi Bisnis</td>
                        <td class="border border-[#132145] px-4 py-2 text-center">3C</td>
                    ...
                    <tr class="bg-white">
                        ...
                        <td class="border border-[#132145] px-4 py-2">Dosen DPA456 </td>
                        <td class="border border-[#132145] px-4 py-2 text-center">Teknik Informatika</td>
                        <td class="border border-[#132145] px-4 py-2 text-center">2I</td>
                    ...
                    <tr class="bg-white">
                        ...
                        <td class="border border-[#132145] px-4 py-2">Dosen DPA567 </td>
                        <td class="border border-[#132145] px-4 py-2 text-center">Teknik Informatika</td>
                        <td class="border border-[#132145] px-4 py-2 text-center">2B</td>
                        <td class="border border-[#132145] px-4 py-2 text-center">dosen567@abc.com</td>
                        <td class="border border-[#132145] px-4 py-2"><img src="../../Public/contohKTM.png" alt=""></td>
