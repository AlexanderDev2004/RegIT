    ...
    <div class="flex w-full mx-auto">
        <div class="w-64 h-screen bg-[#132145] text-white flex flex-col items-center py-6 absolute top-0">
            ...
            <nav class="w-64 flex flex-col">
                ...
                <a href="dataDosen.php" target="" class="flex items-center gap-4 px-6 py-3 mb-2 bg-[#132145] rounded-lg text-white rounded-lg text-sm font-bold hover:bg-yellow-600 bg-[#F99D1C]">
                <img src="../../Public/personalcard.svg" alt="">    
        ...
        <table class="w-full border-collapse border border-[#132145] text-sm text-left">
                ...
                <tbody>
                    <tr class="bg-white">
                        ...
                        <td class="border border-[#132145] px-4 py-2">Dosen123 </td>
                    ...
                    <tr class="bg-white">
                        ...
                        <td class="border border-[#132145] px-4 py-2">Dosen234</td>
                    ...
                    <tr class="bg-white">
                        ...
                        <td class="border border-[#132145] px-4 py-2">Dosen345 </td>
                    ...
                    <tr class="bg-white">
                        ...
                        <td class="border border-[#132145] px-4 py-2">Dosen456 </td>
                    ...
                    <tr class="bg-white">
                        ...
                        <td class="border border-[#132145] px-4 py-2">Dosen567 </td>
