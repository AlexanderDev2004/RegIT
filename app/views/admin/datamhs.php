        ...
        <table class="w-full border-collapse border border-[#132145] text-sm text-left">
                <thead class="bg-white text-gray-800">
                    <tr>
                        ...
                        <th class="border border-[#132145] px-4 py-2">NIM</th>
                        <th class="border border-[#132145] px-4 py-2">Nama Mahasiswa</th>
                ...
                <tbody>
                    <tr class="bg-white">
                        ...
                        <td class="border border-[#132145] px-4 py-2">2341720220</td>
                        <td class="border border-[#132145] px-4 py-2">FIERA ZAIDATTUN NISA’ </td>
                        <td class="border border-[#132145] px-4 py-2 text-center">fieraziadattun@abc.com</td>
                        ...
                        <td class="border border-[#132145] px-4 py-2 text-center">
                            <div class="flex flex-row justify-center space-x-2"> 
                                <button type="button" onclick="window.location.href='detailMahasiswa.php'" 
                    ...
                    <tr class="bg-white">
                        ...
                        <td class="border border-[#132145] px-4 py-2">2341720119</td>
                        <td class="border border-[#132145] px-4 py-2">AKHMAD AAKHIF ATHALAH</td>
                        <td class="border border-[#132145] px-4 py-2 text-center">akhmadaakhif@abc.com</td>
                        <td class="border border-[#132145] px-4 py-2"><img src="../../Public/contohKTM.png" alt=""></td>
                        <td class="border border-[#132145] px-4 py-2 text-center">
                        <div class="flex flex-row justify-center">
                    ...
                    <tr class="bg-white">
                        ...
                        <td class="border border-[#132145] px-4 py-2">2341720290</td>
                        <td class="border border-[#132145] px-4 py-2">IRSA </td>
                        <td class="border border-[#132145] px-4 py-2 text-center">irsa@abc.com</td>
                    ...
                    <tr class="bg-white">
                        ...
                        <td class="border border-[#132145] px-4 py-2">2341720190</td>
                        <td class="border border-[#132145] px-4 py-2">ALEXANDER AGUNG RAYA </td>
                        <td class="border border-[#132145] px-4 py-2 text-center">alexanderagungraya@abc.com</td>
                        <td class="border border-[#132145] px-4 py-2"><img src="../../Public/contohKTM.png" alt=""></td>
                        <td class="border border-[#132145] px-4 py-2 text-center">
                            <div class="flex flex-row justify-center">
                    ...
                    <tr class="bg-white">
                        ...
                        <td class="border border-[#132145] px-4 py-2">2341720190</td>
                        <td class="border border-[#132145] px-4 py-2">MUHAMMAD AL-FATIH ULIMA ROBBY </td>
                        <td class="border border-[#132145] px-4 py-2 text-center">mohalfatih@abc.com</td>
                        <td class="border border-[#132145] px-4 py-2"><img src="../../Public/contohKTM.png" alt=""></td>
