    ...
    <div class="flex w-full mx-auto">
        <div class="w-64 h-screen bg-[#132145] text-white flex flex-col items-center py-6 absolute top-0">
            ...
            <nav class="w-64 flex flex-col">
                ...
                <a href="pelanggaran.php" target="" class="flex items-center gap-4 px-6 py-3 mb-2 bg-[#132145] rounded-lg text-white rounded-lg text-sm font-bold hover:bg-yellow-600 bg-[#F99D1C]">
    ...
    <div class="bg-white p-6 rounded-lg shadow-md w-11/12 lg:w-3/4 ml-80">
        <div class="flex flex-end justify-end">
            <button type="button" onclick="window.location.href='tambahAdmin.php'"
                class="flex items-center w-64 px-4 py-2 mb-2 bg-[#34C759] text-white font-semibold rounded-lg shadow-md hover:bg-green-600 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2">
                    <img src="../../Public/iconTambah.svg" alt="">
        ...
        <table class="w-full border-collapse border border-[#132145] text-sm text-left">
                <thead class="bg-white text-gray-800">
                    <tr>
                        ...
                        <th class="border border-[#132145] px-4 py-2">Nama Pelanggaran</th>
                ...
                <tbody>
                    <tr class="bg-white">
                        ...
                        <td class="border border-[#132145] px-4 py-2">Berkomunikasi dengan tidak sopan, baik tertulis atau tidak tertuliskepada mahasiswa, dosen, karyawan, atau orang lain</td>
                        <td class="border border-[#132145] px-4 py-2">V</td>
                    ...
                    <tr class="bg-white">
                        ...
                        <td class="border border-[#132145] px-4 py-2">Mahasiswa Iaki-laki berambut tidak rapi, gondrong yaitu panjangrarnbutnya melewati batas alis mata di bagian depan, telinga di bagian sarnping atau menyentuh kerah baju di bagian leher</td>
                        <td class="border border-[#132145] px-4 py-2">IV</td>
                        <td class="border border-[#132145] px-4 py-2 text-center">
                    ...
                    <tr class="bg-white">
                        ...
                        <td class="border border-[#132145] px-4 py-2">Mengotori atau mencoret-coret meja, kursi, tembok, dan lain-lain di lingkungan Polinema</td>
                        <td class="border border-[#132145] px-4 py-2">III</td>
                        <td class="border border-[#132145] px-4 py-2 text-center">
                            <div class="flex flex-row justify-center space-x-2"> 
                                <button type="button" onclick="window.location.href='detailPelanggaran.php'" 
                                    class="flex items-center w-28 px-4 py-2 bg-[#132145] text-white font-semibold rounded-lg shadow-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2">
                    ...
                    <tr class="bg-white">
                        ...
                        <td class="border border-[#132145] px-4 py-2">Tidak menjaga ketertiban dan keamanan di seluruh area Polinema (misalnya: parkir tidak pada tempatnya, konvoi selebrasi wisuda dll)</td>
                        <td class="border border-[#132145] px-4 py-2">II</td>
                        <td class="border border-[#132145] px-4 py-2 text-center">
                            <div class="flex flex-row justify-center space-x-2"> 
                                <button type="button" onclick="window.location.href='detailPelanggaran.php'" 
                                    class="flex items-center w-28 px-4 py-2 bg-[#132145] text-white font-semibold rounded-lg shadow-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2">
                    ...
                    <tr class="bg-white">
                        ...
                        <td class="border border-[#132145] px-4 py-2">Melakukan kegiatan atau sejenisnya yang dapat menurunkan kehormatan atau martabat Negara, Bangsa dan Polinema.</td>
                        <td class="border border-[#132145] px-4 py-2">I</td>
                        <td class="border border-[#132145] px-4 py-2 text-center">
                            <div class="flex flex-row justify-center space-x-2"> 
                                <button type="button" onclick="window.location.href='detailPelanggaran.php'" 
                                    class="flex items-center w-28 px-4 py-2 bg-[#132145] text-white font-semibold rounded-lg shadow-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2">
