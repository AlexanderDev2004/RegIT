    ...
    <div class="flex w-full mx-auto">
        <div class="w-64 h-screen bg-[#132145] text-white flex flex-col items-center py-6 absolute top-0">
            ...
            <nav class="w-64 flex flex-col">
                ...
                <a href="dataadmin.php" target="" class="flex items-center gap-4 px-6 py-3 mb-2 bg-[#132145] rounded-lg text-white rounded-lg text-sm font-bold hover:bg-yellow-600 bg-[#F99D1C]">
                <img src="../../Public/personalcard.svg" alt="">
    ...
    <div class="bg-white p-6 rounded-lg shadow-md w-11/12 lg:w-3/4 ml-80">
        <div class="flex flex-end justify-end">
            <button type="button" onclick="window.location.href='tambahAdmin.php'"
                class="flex items-center w-32 px-4 py-2 mb-2 bg-[#34C759] text-white font-semibold rounded-lg shadow-md hover:bg-green-600 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2">
        ...
        <table class="w-full border-collapse border border-[#132145] text-sm text-left">
                ...
                <tbody>
                    <tr class="bg-white">
                        ...
                        <td class="border border-[#132145] px-4 py-2">Admin123 </td>
                        <td class="border border-[#132145] px-4 py-2 text-center">admin123@abc.com</td>
                    ...
                    <tr class="bg-white">
                        ...
                        <td class="border border-[#132145] px-4 py-2">Admin234</td>
                        <td class="border border-[#132145] px-4 py-2 text-center">admin234@abc.com</td>
                        <td class="border border-[#132145] px-4 py-2"><img src="../../Public/contohKTM.png" alt=""></td>
                        <td class="border border-[#132145] px-4 py-2 text-center">
                        <div class="flex flex-row justify-center">
                    ...
                    <tr class="bg-white">
                        ...
                        <td class="border border-[#132145] px-4 py-2">Admin345 </td>
                        <td class="border border-[#132145] px-4 py-2 text-center">admin345@abc.com</td>
                    ...
                    <tr class="bg-white">
                        ...
                        <td class="border border-[#132145] px-4 py-2">Admin456 </td>
                        <td class="border border-[#132145] px-4 py-2 text-center">admin456@abc.com</td>
                        <td class="border border-[#132145] px-4 py-2"><img src="../../Public/contohKTM.png" alt=""></td>
                        <td class="border border-[#132145] px-4 py-2 text-center">
                            <div class="flex flex-row justify-center">
                    ...
                    <tr class="bg-white">
                        ...
                        <td class="border border-[#132145] px-4 py-2">Admin567 </td>
                        <td class="border border-[#132145] px-4 py-2 text-center">admin567@abc.com</td>
                        <td class="border border-[#132145] px-4 py-2"><img src="../../Public/contohKTM.png" alt=""></td>
