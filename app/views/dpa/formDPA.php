            ...
            <label for="nim" class="block text-sm font-bold text-black">NIM</label>
                <form action="#" class="order-first mb-10 md:mb-0 md:order-last md:pr-8 mt-6">
                    ...
                    <div class="flex justify-between mt-6 pt-4">
                        <button type="submit" class="bg-green-600 text-white px-4 py-2 rounded-md shadow hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-green-500" onclick="window.location.href='pelanggaran'">Simpan</button>
