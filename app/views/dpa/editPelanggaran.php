...
<body class="bg-[#EBEEF5] font-poppins">
    ...
    <div class="flex w-full mx-auto">
        <div class="w-64 h-screen bg-[#132145] text-white flex flex-col items-center py-6 absolute top-0">
            ...
            <nav class="w-64 flex flex-col">
                ...
                <a href="formDPA.php" target="" class="flex items-center gap-4 px-6 py-3 mb-2 bg-[#132145] rounded-lg text-white rounded-lg text-sm font-bold hover:bg-yellow-600 ">
    ...
    <div id="Form"class="flex justify-center items-center pt-8">
        <p class="font-bold text-3xl flex text-center items-center text-[#132145] ml-8 flex flex-col justify-center">Edit Data Pelanggaran</p>
    </div>
