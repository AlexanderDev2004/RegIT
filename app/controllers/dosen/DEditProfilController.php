...
require_once './app/models/dosen/DEditProfilModel.php';
...
class DEditProfilController extends Controller {
    ...
    public function submitNewPassword(){
        ...
        header("Location: " . BASE_URL . "/dosen/profil");
    }
}
